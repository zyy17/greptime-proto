...
type NodeInfo struct {
	...
	UsedCpuMillicores uint32 `protobuf:"varint,7,opt,name=used_cpu_millicores,json=usedCpuMillicores,proto3" json:"used_cpu_millicores,omitempty"`
	// The used memory bytes of the node.
	UsedMemoryBytes uint64 `protobuf:"varint,8,opt,name=used_memory_bytes,json=usedMemoryBytes,proto3" json:"used_memory_bytes,omitempty"`
...
func (x *NodeInfo) GetMaxCpuMillicores() uint32 {
	if x != nil {
...
func (x *NodeInfo) GetMaxMemoryBytes() uint64 {
	if x != nil {
...
func (x *NodeInfo) GetUsedCpuMillicores() uint32 {
	if x != nil {
...
func (x *NodeInfo) GetUsedMemoryBytes() uint64 {
	if x != nil {
...
var file_greptime_v1_meta_heartbeat_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x6c, 0x69, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x65, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x75, 0x73, 0x65, 0x64, 0x43, 0x70,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x75, 0x73, 0x65, 0x64, 0x4d, 0x65, 0x6d, 0x6f,
